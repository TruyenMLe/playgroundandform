 ...
 */
package com.playgroundandform.core.models;
...
import com.playgroundandform.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "playgroundandform/components/helloworld");
